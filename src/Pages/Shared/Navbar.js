    ...
    <>
      <header className="header">
        <div className="d_flex md:px-7">
          ...
          <div className="Links">
            <ul
              className={Mobile ? "nav-links-mobile" : "links f_flex uppercase"}
            ...
            >
              ...
              <li>
                ...
                {user ? (
                  <button
                    onClick={logout}
                    className="btn btn-Link btn-outline fs-5"
                  >
                    Sign out
                  </button>
                ) : (
                  <>
                    <li class="dropdown dropdown-hover">
                      ...
                      >
                        <li>
                          <Link to="/studentRegister" className="text-xl ">
                            Register
                          </Link>
                        </li>
                        <li>
                          <Link to="/studentLogin" className="text-xl ">
                            Login
                          </Link>
                        </li>
                      </ul>
